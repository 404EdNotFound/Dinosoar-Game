...
jumpSound = pygame.mixer.Sound("C://Users//Edwin//Documents//Python//Pygame Module//jump.wav")
hundredScore = pygame.mixer.Sound("C://Users//Edwin//Documents//Python//Pygame Module//point.wav")
death = pygame.mixer.Sound("C://Users//Edwin//Documents//Python//Pygame Module//die.wav")
music = pygame.mixer.music.load("C://Users//Edwin//Documents//Python//Pygame Module//Gaming Music.mp3")
...
while run:
    ...
    if not(game_over): #Needed help with this
        ...
        if not deathPlayed:
            music = pygame.mixer.music.load("C://Users//Edwin//Documents//Python//Pygame Module//Game Over.mp3")
            pygame.mixer.music.play(-1)
            death.play()
            deathPlayed = True
